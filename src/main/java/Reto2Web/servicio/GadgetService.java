 ...
 */
package Reto2Web.servicio;

import Reto2Web.modelo.Gadget;
import Reto2Web.repositorio.GadgetRepositorio;
...
public class GadgetService {
    ...
    @Autowired
    private GadgetRepositorio clotheRepository;
    ...
    public Gadget update(Gadget accesory) {
        ...
        if (accesory.getReference() != null) {
            Optional<Gadget> accesoryDb = clotheRepository.getClothe(accesory.getReference());
            if (!accesoryDb.isEmpty()) {
                ...
                if (accesory.getName() != null) {
                    accesoryDb.get().setCategory(accesory.getName());
